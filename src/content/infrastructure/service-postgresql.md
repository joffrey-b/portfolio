...
A shared PostgreSQL instance running in the Docker stack, used as backing storage for the self-hosted apps that need it, alongside the separate MariaDB instance for apps that need MySQL compatibility instead.
