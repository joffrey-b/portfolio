...
Joplin is a self-hosted, end-to-end encrypted note-taking app, synced across desktop and mobile clients via its own sync server running in the Docker stack.
