...
Une instance MariaDB partagée tournant dans la stack Docker, utilisée comme stockage par les applications auto-hébergées ayant besoin d'un stockage compatible MySQL plutôt que chaque application n'embarque son propre conteneur de base de données. Elle sert actuellement de stockage pour phpIPAM et Nextcloud.
