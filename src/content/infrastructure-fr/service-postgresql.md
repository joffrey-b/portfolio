...
Une instance PostgreSQL partagée tournant dans la stack Docker, utilisée comme stockage par les applications auto-hébergées qui en ont besoin, aux côtés de l'instance MariaDB séparée pour celles qui nécessitent une compatibilité MySQL. Elle sert actuellement de stockage pour Joplin et Mealie ; Koito l'utilisait aussi avant de migrer vers sa propre base SQLite.
