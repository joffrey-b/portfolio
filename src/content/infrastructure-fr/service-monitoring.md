...
type: "service"
subtitle: "Centreon"
description: "Plateforme de supervision des services et des performances avec des contrôles SNMP. Envoi d'alertes e-mail via Postfix."
order: 7
...
Centreon gère les contrôles de santé au niveau des services et des hôtes dans tout le homelab via SNMP, distinct des métriques time-series de Grafana.

Voir [Centreon](/fr/infrastructure/service-centreon) dans les applications auto-hébergées pour plus de détails.
